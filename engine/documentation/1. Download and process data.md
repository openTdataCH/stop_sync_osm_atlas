...
The result bundle carries complete matches, unmatched records, groups, problems, routes and optional Swiss identity extensions. The review app consumes that bundle and does not read these raw/processed files. See [the result and import boundary](../../documentation/5.1%20Import%20Process.md).
