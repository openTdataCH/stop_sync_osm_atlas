...
Each result bundle records the run-specific number of name-based matches.
...
- Earlier exact-reference matching commonly resolves the strongest identifier-based cases first
