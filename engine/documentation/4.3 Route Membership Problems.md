# E4.3 Route Membership Problems
...
## 4.3.1 Membership Mismatch (Planned)
...
## 4.3.2 Sequence Mismatch (Planned)
...
## 4.3.3 Direction Mismatch (Planned)

**Definition**: A stop is a member of the route in both datasets, but the directional context differs.

*   **Direction**: Different paired itineraries or destination/headsign names ("Towards A" vs "Towards B").
*   **Member role**: Direction-sensitive OSM roles such as entry-only or exit-only where present.
...
- [E4.2 Route Entity Problems](4.2%20Route%20Entity%20Problems.md)
- [4.1 Stop Problems](4.1%20Stop%20Problems.md)
