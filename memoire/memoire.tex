...
\defref{ref:docker_secrets}{Docker. Docker secrets [en ligne]. Disponible sur : \url{https://docs.docker.com/engine/swarm/secrets/} (consulté le 2025-08-17).}

\defref{ref:hrdf_cookbook}{Open Transport Data Swiss. HRDF Cookbook [en ligne]. Disponible sur : \url{https://opentransportdata.swiss/en/cookbook/timetable-cookbook/hafas-rohdaten-format-hrdf/} (consulté le 2025-08-17).}
