...
\noindent Un CAPTCHA Cloudflare Turnstile\citeref{ref:cloudflare_turnstile} protège inscription et connexion.
...
\begin{figure}[h]
  \centering
  \fbox{\parbox{0.9\textwidth}{\centering Placeholder capture d'écran: message UI \og Mot de passe incorrect \fg{} suivi d'un \og Compte temporairement verrouillé \fg{}.}}
...
\begin{figure}[h]
  \centering
  \fbox{\parbox{0.9\textwidth}{\centering Placeholder capture d'écran: saisie d'un code 2FA \textbf{incorrect} avec message d'erreur.}}
...
\begin{figure}[h]
  \centering
  \fbox{\parbox{0.9\textwidth}{\centering Placeholder capture d'écran: tentative d'inscription avec un email existant et message révélant l'existence du compte.}}
