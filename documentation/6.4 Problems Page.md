...
- [4. Problems](../engine/documentation/4.%20Problems.md) — Problem detection and prioritization pipeline
- [4.1 Stop Problems](../engine/documentation/4.1%20Stop%20Problems.md) — Stop-level problem predicates (distance, attributes, unmatched, duplicates)
