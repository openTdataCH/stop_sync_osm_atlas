...
flowchart TB
    ...
    CTX --> OSM["osm.get_by_uic(uic_ref)<br/><i>excl. stations + used + siblings</i>"]
...
> **Implementation note**: the current predicate records `distance_m = 0.0` for exact matches instead of computing haversine distance.
