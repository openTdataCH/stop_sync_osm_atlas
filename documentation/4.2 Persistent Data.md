...
3) `apply_persistent_solutions()` in [backend/services/import_persistence.py](https://github.com/openTdataCH/stop_sync_osm_atlas/blob/main/backend/services/import_persistence.py) applies persisted solutions and notes to the fresh data.
...
See also: [Permissions](https://github.com/openTdataCH/stop_sync_osm_atlas/blob/main/documentation/6.1%20Permissions.md) for who can access these endpoints.
