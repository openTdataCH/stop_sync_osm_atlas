# 7. Engine and Review Application Architecture

The codebase contains two independently runnable projects. `engine/` is an installable Python package with its own tests, examples and Dockerfile. The repository root is the review application: Flask, PostGIS, browser UI, documentation and deployment jobs. They are kept in one checkout for this review; `engine/` can be moved to its own repository without app-code imports.
...
See [result publication](5.1%20Import%20Process.md), [builds and dependencies](7.1%20Dependency%20Management%20&%20Build%20Strategy.md), [scheduling](7.3%20Background%20Scheduler.md), [source caching](7.4%20Atlas-Cached%20Import%20Optimization.md), [pipeline performance](7.5%20Pipeline%20Performance.md), and [contributing](9.%20Contributing.md).
