# A1.1 Result Bundle Import and Publication
...
`DB_IMPORT_METHOD=insert` selects the ORM comparison writer. See [Pipeline Performance](../engine/documentation/5.2%20Pipeline%20Performance.md) for transaction details, logs, settings and validation.
