...
The Problems page (`/problems`) surfaces data quality issues detected by the matching engine ([Section 4](../engine/documentation/4.%20Problems.md)) and presents them for review. Users can browse, filter, and navigate through problems while viewing the affected stops on an interactive map.
...
| **Unmatched** | `fa-map-marker-alt` | ATLAS stop has no OSM match (or vice versa) | P1, P2, P3 |
| **Attributes** | `fa-tags` | Matched pair has mismatched attributes (name, operator, etc.) | P1, P2, P3 |
| **Contradicts Route Matching** | `fa-route` | The matched pair conflicts with available route evidence | P2 |
...
| `priority` | — | One or more comma-separated priority levels, for example `1` or `1,2,3` |
...
- [E4 Problems](../engine/documentation/4.%20Problems.md) — Problem detection and prioritization pipeline
- [E4.1 Stop Problems](../engine/documentation/4.1%20Stop%20Problems.md) — Stop-level problem predicates (distance, attributes, unmatched, duplicates)
- [A2 Web app](2.%20Web%20app.md) — Web application overview
- [A2.1 Map Data Loading](2.1%20Map%20Data%20Loading%20and%20Rendering.md) — Map rendering pipeline (shared components)
