...
1. **Bulletproof imports** — `matching_and_import_db/import_data_db.py` uses `TRUNCATE CASCADE` to clear all import tables instantly, with zero risk of touching user data.
...
- **[4.3 Import Process](4.3%20Import%20Process.md)** — How `matching_and_import_db/import_data_db.py` transforms CSV files into database records