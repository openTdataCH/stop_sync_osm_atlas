...
> Last updated: {{stat:atlas_filtering.downloaded_at}}. The validity filter currently eliminates 0 rows because the dataset appears to ship only active entries.
