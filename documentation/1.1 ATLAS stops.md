...
> [!NOTE]
> We do not download ATLAS and GTFS data on every run. Before preprocessing, the scheduler checks the source permalinks for updated file validators and reuses the existing artifacts when both sources are unchanged. More info in [6.3. Background Scheduler](6.3.%20Background%20Scheduler.md).
>
