...
- [3.2 Route-Route Matching](3.2%20Route-Route%20Matching.md) – Route-level source↔OSM linking in the engine
...
All predicate logic is in [predicates/route_matching_gtfs.py](../engine/src/transport_matcher/core/predicates/route_matching_gtfs.py). Route state logic lives in [route_state.py](../engine/src/transport_matcher/core/route_state.py).
