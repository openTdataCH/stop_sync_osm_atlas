...
Operator normalization: see [OSM operator normalization](/docs/1.2.1%20OSM%20operator%20normalization) (OSM operators normalized before comparisons).
...
- API groups duplicates in `/api/problems` for UI (see [backend/blueprints/problems.py](https://github.com/openTdataCH/stop_sync_osm_atlas/blob/main/backend/blueprints/problems.py))
