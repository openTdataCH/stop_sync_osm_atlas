...
The database is wiped and rebuilt on every pipeline run. Solution persistence (feeding user corrections back into the pipeline) is modelled but not yet active. See [5. Database](5.%20Database.md) for details.
...
| **[5. Database](5.%20Database.md)** | Schema, import process, and persistence |
