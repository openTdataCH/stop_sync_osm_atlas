...
<!-- DEPENDENCIES_START -->
- `requirements-base.txt`: Shared core backend foundations requested by all containers (`eralchemy2>=1.4.1,<2.0`, `Flask-SQLAlchemy>=3.1.1,<4.0`, `Flask>=3.1.3,<4.0`, `GeoAlchemy2>=0.19.0,<1.0`, `psycopg[binary]>=3.3.3,<4.0`, `redis>=7.4.0,<8.0`, `requests>=2.33.1,<3.0`, `SQLAlchemy>=2.0.49,<3.0`).
