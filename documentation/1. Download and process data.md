...
3.  **`atlas_routes_unified.csv`** (processed): A GTFS-derived list of routes and directions associated with each ATLAS stop.
...
| `atlas_routes_unified.csv` | GTFS routes per sloid | Route matching, DB import |
