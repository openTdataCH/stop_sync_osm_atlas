...
## 3.2.1 Unmatched Route

**Definition**: A route exists in one dataset but has no corresponding route in the other.

*   **ATLAS-only**: Route appears in GTFS/HRDF but has no corresponding OSM route relation.
