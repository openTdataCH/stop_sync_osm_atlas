...
| **2.5c** | [`manual_match`](2.5%20Post-processing.md) | `manual` | User-provided pairs from the database |
...
| `get_all_rows_as_dict()` | All records keyed by SLOID (used by `manual_match`) |
...
| Post-processing | [postpass_matching.py](../matching_and_import_db/predicates/postpass_matching.py) | `postpass_unique_uic()`, `duplicate_propagation()`, `manual_match()` |
