...
2. **Pairs second** for all remaining reciprocal sibling pairs.
...
5. The same strict-vs-incomplete policy now applies to `osm_pair_uic`, `osm_pair_name`, and `osm_pair_tram`.
