...
flowchart LR
    ...
    G --> H["Exact UIC"]
    H --> I["Name"]
    I --> J["Distance: group / local_ref / nearest"]
    J --> K["Route"]
    K --> L["Post-pass"]
    L --> M["PipelineResult"]
    M --> N["MatchingOutput"]
...
```mermaid
flowchart TD
    classDef behavior fill:#d97706,color:#fff,stroke:#b45309,stroke-width:2px
    classDef orchestration fill:#1f2937,color:#fff,stroke:#111827,stroke-width:2px
    classDef state fill:#2563eb,color:#fff,stroke:#1d4ed8,stroke-width:2px
    classDef model fill:#7c3aed,color:#fff,stroke:#6d28d9,stroke-width:2px
    classDef action fill:#059669,color:#fff,stroke:#047857,stroke-width:2px
...
4. The same strict-vs-incomplete policy now applies to `osm_group_uic`, `osm_group_name`, and `osm_group_tram`.
...
`unmatched_atlas` contains unmatched representatives, not hidden duplicate siblings. `unmatched_osm` contains unmatched non-sibling OSM representatives, including stations if they were never used.
