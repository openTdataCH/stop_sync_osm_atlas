...
| `2.4` | [`RouteMatchPredicate`](2.4%20Stop-stop%20matching%20using%20routes.md) | `route_gtfs_gtfs` | Still limited to 50 m, then tries normalized GTFS route-id tokens and direction-name fallback |
