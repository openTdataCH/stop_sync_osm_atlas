...
| **Unmatched ATLAS** | {{stat:summary.unmatched_source}} |
...
| Component | File |
|-----------|------|
| Domain models | [models.py](../engine/src/transport_matcher/core/models.py) |
| Swiss adapter runner | [swiss.py](../engine/src/transport_matcher/swiss.py) |
| Pipeline framework | [pipeline.py](../engine/src/transport_matcher/core/pipeline.py) |
| State management | [state.py](../engine/src/transport_matcher/core/state.py) |
| Exact matching | [predicates/exact_matching.py](../engine/src/transport_matcher/core/predicates/exact_matching.py) |
| Name matching | [predicates/name_matching.py](../engine/src/transport_matcher/core/predicates/name_matching.py) |
| Distance matching | [predicates/distance_matching.py](../engine/src/transport_matcher/core/predicates/distance_matching.py) |
| Route matching | [predicates/route_matching_gtfs.py](../engine/src/transport_matcher/core/predicates/route_matching_gtfs.py) |
| Spatial index | [utils/spatial_index.py](../engine/src/transport_matcher/core/utils/spatial_index.py) |
