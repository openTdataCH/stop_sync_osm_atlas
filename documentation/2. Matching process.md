...
| `2.5` | [`RouteMatchPredicate`](2.4%20Stop-stop%20matching%20using%20routes.md) | `route_gtfs_gtfs` | Still limited to 50 m, then tries GTFS route tokens and direction-name fallback |
...
| Route matching | Yes | `get_by_uic()`, `get_by_name()`, and non-station KDTree queries hide stations |
