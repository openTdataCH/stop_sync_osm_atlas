...
```mermaid
flowchart LR
    T["2.1 Trio distance"] --> E["2.2 Exact"] --> N["2.3 Name"] --> R["2.4 Route"] --> D1["2.5a Group proximity"] --> D2["2.5b Local ref"] --> D3["2.5c Nearest 3a"] --> D4["2.5d Nearest 3b"] --> D5["2.5e Nearest 3a retry"] --> P["2.6 Post-pass"]
```
...
| `2.4` | [`RouteMatchPredicate`](2.4%20Stop-stop%20matching%20using%20routes.md) | `route_gtfs_tokens`, `route_gtfs_direction` | Still limited to 50 m, then commits only mutual unique-best route-supported edges: GTFS token overlap first and exact direction-name fallback second; equal-strength ambiguities are skipped |
| `2.5a` | [`GroupProximityPredicate`](2.3%20Distance%20matching.md) | `distance_matching_1_uic_ref`, `distance_matching_1_uic_name`, `distance_matching_1_name` | Conflict-free maximum-cardinality assignment within grouped ATLAS and OSM candidates |
| `2.5b` | [`LocalRefDistancePredicate`](2.3%20Distance%20matching.md) | `distance_matching_2` | Exact `designation == local_ref` within 50 m |
| `2.5c` | [`NearestDistancePredicate`](2.3%20Distance%20matching.md) | `distance_matching_3a` | First single-candidate nearest-distance pass within 50 m |
| `2.5d` | [`NearestDistancePredicate`](2.3%20Distance%20matching.md) | `distance_matching_3b` | Ratio-test nearest-distance pass within 50 m |
| `2.5e` | [`NearestDistancePredicate`](2.3%20Distance%20matching.md) | `distance_matching_3a_second_pass` | Second single-candidate nearest-distance retry after ratio-pass locking |
