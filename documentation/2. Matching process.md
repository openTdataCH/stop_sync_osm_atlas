...
```mermaid
flowchart LR
    T["2.1 Trio distance"] --> E["2.2 Exact"] --> N["2.3 Name"] --> D1["2.4a Group proximity"] --> D2["2.4b Local ref"] --> D3["2.4c Nearest"] --> R["2.5 Route"] --> P["2.6 Post-pass"]
```
...
| `2.4a` | [`GroupProximityPredicate`](2.3%20Distance%20matching.md) | `distance_matching_1_uic_ref`, `distance_matching_1_uic_name`, `distance_matching_1_name` | Conflict-free bipartite matching for equal-sized ATLAS and OSM groups |
| `2.4b` | [`LocalRefDistancePredicate`](2.3%20Distance%20matching.md) | `distance_matching_2` | Exact `designation == local_ref` within 50 m |
| `2.4c` | [`NearestDistancePredicate`](2.3%20Distance%20matching.md) | `distance_matching_3a`, `distance_matching_3b` | Single-candidate proximity or ratio-test proximity within 50 m |
