...
| `2` | [`ExactUicPredicate`](2.1%20Exact%20matching.md) | `exact` | Matches `AtlasNode.uic_ref` to `OsmNode.uic_ref`; when both sides have multiples, refines by `designation == local_ref` |
