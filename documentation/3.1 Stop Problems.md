...
This problem type is intentionally fixed at **P2**. It is strong enough to indicate a likely matching issue, but it is currently not shown in the main problems UI section.
