...
Run [get_atlas_data.py](https://github.com/openTdataCH/stop_sync_osm_atlas/blob/main/Download_and_process_data/get_atlas_data.py)
...
[matching_process/route_matching_unified.py](https://github.com/openTdataCH/stop_sync_osm_atlas/blob/main/matching_process/route_matching_unified.py)
...
`import_to_database()` in [import_data_db.py](https://github.com/openTdataCH/stop_sync_osm_atlas/blob/main/import_data_db.py)
