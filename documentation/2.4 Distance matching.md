...
Distance matching uses spatial proximity to produce matches. It consists of **four predicate classes** contributing **six sequential predicate runs**. 
...
flowchart TD
    ...
    subgraph S3["Stage 2: Distance Block"]
        G["Group proximity"] --> L["Local ref"] --> N1["Nearest 3a"] --> N2["Nearest 3b"] --> N3["Nearest 3a retry"]
    end
