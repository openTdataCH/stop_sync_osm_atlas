...
- the request identity is built from the viewport policy's non-bounding-box parameters plus its mode; this includes `offset`, `zoom`, `include_meta`, and any active `limit`
