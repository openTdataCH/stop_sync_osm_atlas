...
| File | Description |
| :--- | :--- |
| [`service.py`](file:///Users/guillemmassague/Desktop/stop_sync_osm_atlas/matching_and_import_db/scheduler/service.py) | APScheduler setup, interval trigger, next-run publishing |
| [`job_runner.py`](file:///Users/guillemmassague/Desktop/stop_sync_osm_atlas/matching_and_import_db/scheduler/job_runner.py) | Pipeline orchestration, phase sequencing, lock management |
| [`pipeline_status.py`](file:///Users/guillemmassague/Desktop/stop_sync_osm_atlas/backend/services/pipeline_status.py) | Redis read/write for status, locking primitives |
| [`pipeline-status.js`](file:///Users/guillemmassague/Desktop/stop_sync_osm_atlas/static/js/shared/pipeline-status.js) | Browser-side polling, navbar/overlay updates |
| [`navbar.html`](file:///Users/guillemmassague/Desktop/stop_sync_osm_atlas/templates/components/navbar.html) | Server-rendered "Data updated" label + next-run tooltip |
| [`docker-compose.yml`](file:///Users/guillemmassague/Desktop/stop_sync_osm_atlas/docker-compose.yml) | Container definition, env vars, depends_on ordering |
