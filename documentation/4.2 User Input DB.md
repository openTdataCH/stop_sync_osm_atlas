...
The user-input database (`user_input_db`, env var `USER_INPUT_DATABASE_URI`) preserves user-created solutions, notes, and authentication data across data imports.
...
The persistent data is split into two primary tables within `user_input_db`:

### `persistent_data` (Solutions)
