...
|----------|----------|-----------|----------|
| **Import** | `import_db` | `stops_matched`, `atlas_stops`, `osm_nodes`, `osm_stops`, `osm_stop_members`, `route_atlas_stops`, `route_osm_stops`, `routes_matched`, `problems` | TRUNCATED and repopulated |
