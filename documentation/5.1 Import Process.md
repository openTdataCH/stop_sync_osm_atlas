...
`DB_IMPORT_METHOD=insert` selects the ORM comparison writer. See [Pipeline Performance](../engine/documentation/7.5%20Pipeline%20Performance.md) for transaction details, logs, settings and validation.
