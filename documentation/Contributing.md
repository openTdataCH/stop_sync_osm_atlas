...
|---|---|---|
| A matching predicate or dataset profile | [Engine contributor guide](../engine/CONTRIBUTING.md) | Engine offline tests. |
...
The current checkout contains both independently runnable projects to make the extraction reviewable. Engine releases have their own package version. Creating external repositories, publishing packages and deploying the refactor are separate maintainer actions after review.
