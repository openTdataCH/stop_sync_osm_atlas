...
| `match_type` | String(50) | Examples: `exact`, `exact_postpass`, `name`, `distance_matching_trio`, `distance_matching_*`, `route_gtfs_*`, `duplicate_propagation`, `osm_group_propagation`, `no_nearby_counterpart` |
